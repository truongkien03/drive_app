...
class LocationService {
  ...
  /// Initialize LocationService - static method for main.dart
  static Future<void> initialize() async {
    try {
      print('🗺️ Initializing LocationService...');

      final instance = LocationService();

      // Check location permissions during initialization
      final hasPermission = await instance.checkLocationPermission();
      if (hasPermission) {
        print('✅ LocationService initialized successfully with permissions');
      } else {
        print('⚠️ LocationService initialized but location permissions not granted');
      }
    } catch (e) {
  ...
  /// Gửi tọa độ lên Firebase Realtime Database
  ...
  /// Cập nhật trạng thái online/offline lên Firebase
